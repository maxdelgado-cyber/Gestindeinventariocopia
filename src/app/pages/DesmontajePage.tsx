...
export function DesmontajePage() {
  ...
  const loadData = async () => {
    ...
    // Load all events, montajes, and desmontajes
    const events = await eventsAPI.getAll();
    console.log('📋 [DESMONTAJE] Eventos cargados:', events);
    console.log('🔍 [DESMONTAJE] Eventos con montaje realizado:', events.filter((e: Event) => e.montajeRealizado));
    console.log('🔍 [DESMONTAJE] Eventos pendientes de desmontaje:', events.filter((e: Event) => e.montajeRealizado && !e.desmontaljeRealizado));
    
    setEventos(events);
    const montajesData = await montajesAPI.getAll();
    console.log('📦 [DESMONTAJE] Montajes cargados:', montajesData);
    setMontajes(montajesData);
    const desmontajesData = await desmontajesAPI.getAll();
    console.log('🔙 [DESMONTAJE] Desmontajes cargados:', desmontajesData);
    setDesmontajes(desmontajesData);
  };
